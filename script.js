...
const PARTIES = [
  { id: "01", slug: "fdi", initials: "FdI", name: "Fratelli d'Italia", leader: "Giorgia Meloni", color: PARTY_COLORS.fdi, values: emptyValues() },
  { id: "02", slug: "lega", initials: "LEGA", name: "Lega", leader: "Matteo Salvini", color: PARTY_COLORS.lega, values: emptyValues() },
  { id: "03", slug: "fi", initials: "FI", name: "Forza Italia", leader: "Antonio Tajani", color: PARTY_COLORS.fi, values: emptyValues() },
  { id: "04", slug: "noimoderati", initials: "NM", name: "Noi Moderati", leader: "Maurizio Lupi", color: PARTY_COLORS.noimoderati, values: emptyValues() },
  { id: "05", slug: "pd", initials: "PD", name: "Partito Democratico", leader: "Elly Schlein", color: PARTY_COLORS.pd, values: emptyValues() },
  { id: "06", slug: "m5s", initials: "M5S", name: "Movimento 5 Stelle", leader: "Giuseppe Conte", color: PARTY_COLORS.m5s, values: emptyValues() },
  { id: "07", slug: "avs", initials: "AVS", name: "Alleanza Verdi e Sinistra", leader: "Angelo Bonelli / Nicola Fratoianni", color: PARTY_COLORS.avs, values: emptyValues() },
  { id: "08", slug: "iv", initials: "IV", name: "Italia Viva", leader: "Matteo Renzi", color: PARTY_COLORS.iv, values: emptyValues() },
  { id: "09", slug: "piueuropa", initials: "+EU", name: "+Europa", leader: "Riccardo Magi", color: PARTY_COLORS.piueuropa, values: emptyValues() },
  { id: "10", slug: "azione", initials: "AZ", name: "Azione", leader: "Carlo Calenda", color: PARTY_COLORS.azione, values: emptyValues() },
  { id: "11", slug: "fn", initials: "FN", name: "Futuro Nazionale", leader: "Roberto Vannacci", color: PARTY_COLORS.fn, values: emptyValues() },
  { id: "12", slug: "pld", initials: "PLD", name: "Partito Liberal Democratico", leader: "n/d nelle fonti consultate", color: PARTY_COLORS.pld, values: emptyValues() },
];
...
// Fallback loghi: prova assets/logos/{slug}.svg, poi .png, poi mostra il monogramma.
// Aggiungi i file dei loghi (fonte legittima: sito ufficiale del partito o Wikimedia Commons,
// verifica sempre i termini d'uso) in assets/logos/ con questi nomi esatti per attivarli.
